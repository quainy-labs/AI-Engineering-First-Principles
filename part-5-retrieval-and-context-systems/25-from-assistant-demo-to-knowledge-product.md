...
Chapter 24 measured grounded behavior. This chapter makes the system maintainable.

Prototype answers questions. Product stays trustworthy after documents, users, policies, and risks change.
...
Most important operational loop:
...
Part 6 designs the user control surface before action. Grounded knowledge becomes more powerful only when users can inspect evidence, correct output, approve risky steps, and stop the system.
