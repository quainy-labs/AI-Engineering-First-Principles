# Chapter 14: Context Engineering and Grounding
...
```text
If retrieved context does not contain direct support, answer: "I do not have enough approved information to answer."
```
