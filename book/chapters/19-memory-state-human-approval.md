# Chapter 19: Memory, State, and Human Approval
...
Next chapter puts pieces together: agents. But agents are not magic. They are bounded workflows with tools, state, and stop conditions.
