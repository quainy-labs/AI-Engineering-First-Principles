# Chapter 18: Workflow Orchestration

## Real Problem

An operations assistant must handle:
...
This is not one model call. It is workflow.
...
For production, workflow should be explicit unless true autonomy is clearly needed and evaluated.
