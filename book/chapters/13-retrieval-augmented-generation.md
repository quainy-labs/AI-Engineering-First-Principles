...
Retrieval-Augmented Generation, or RAG, solves this by retrieving trusted information first, then asking model to answer using that information.
...
- retrieval miss -> improve query/chunk/metadata;
